...
return {
  ...
  background_color = blingbling_theme.background_color or "#0a0a0a" ;
  graph_background_color = blingbling_theme.graph_background_color or "#0a0a0a" ;
  ...
  graph_color= blingbling_theme.graph_color or "#94898c";
  graph_line_color= blingbling_theme.graph_line_color or "#94898c" ;
  text_color= blingbling_theme.text_color or "#94898c" ;
